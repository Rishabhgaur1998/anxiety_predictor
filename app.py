...
def predict101():
    ...
    ans_res=" "
    if output == -1:
        ans_res = f"Thanks for your response, bhenchod. Your anxiety score is {output},hence your anxiety levels for today would be slightly less than normal "
    elif output == -5:
        ans_res = f"Thanks for your response. Your anxiety score is {output},hence your anxiety levels for today would be almost zero "
    elif output == 3:
        ans_res = f"Thanks for your response. Your anxiety score is {output},hence your anxiety levels for today would be above normal "
    elif output == 7:
        ans_res = f"Thanks for your response. Your anxiety score is {output},hence your anxiety levels for today very high"

    print(type(output))


    # return render_template("test1_ht.html",n = name )
    return render_template('test1_ht.html', prediction_text=f'{fme} ,{ans_res} ')
